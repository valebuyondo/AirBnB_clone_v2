...
AirBnB_clone_v2 is a complete RESTful web application, integrating file and
...
AirBnB_clone_v2 is still in active development, with complete functionality set to
...
The front-end of AirBnB_clone_v2 was designed from scratch using HTML5/CSS3 pages
...
AirBnB_clone_v2 supports the following classes:
...
In `FileStorage` mode, every time the backend is initialized, AirBnB_clone_v2
...
In `DBStorage` mode, every time the backend is initialized, AirBnB_clone_v2
...
of AirBnB_clone_v2. It can be used to handle and manipulate all classes utilized by
the application (achieved by calls on the `storage` object defined above).

### Using the Console

The AirBnB_clone_v2 console can be run both interactively and non-interactively.
...
Alternatively, to use the AirBnB_clone_v2 console in interactive mode, run the
...
The AirBnB_clone_v2 console supports the following commands:
...
Unittests for the AirBnB_clone_v2 project are defined in the [tests](./tests)
...
## Authors :black_nib:
* **Wilbrod Mutesi**<>
* **Buyondo Vale** <https://github.com/valebuyondo>
